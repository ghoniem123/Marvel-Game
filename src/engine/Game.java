	...
	public void attack(Direction d)
		...
		for (Effect e : c.getAppliedEffects()) {
			if (e instanceof Disarm)
				throw new ChampionDisarmedException("you cannot attack while being disarmed");
		}
		if (c.getCurrentActionPoints() < 2)
			throw new NotEnoughResourcesException("You need at least 2 action point in order to attack");
		int i = 1;
		boolean found = false;
